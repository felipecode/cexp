...
from cexp.srunner.challenge import ChallengeStatisticsManager
from cexp.srunner.scenariomanager.carla_data_provider import CarlaDataProvider
from cexp.srunner.scenariomanager.timer import GameTime, TimeOut
...
class ScenarioManager(object):
    ...
    #  REMOVED LOAD SCENARIO    def load_scenario`(self, scenario, agent=None):
...
# Removed def analyze_scenario(self, stdout, filename, junit):